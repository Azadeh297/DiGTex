...
def generate_sudo_labels(prompt,LLM,prompt_type, label_list, reverse_label_map, batch_size, dataset_name):
    ...
    if prompt_type in ["Minimalist","Neighbor-Guided"]:
        classification_prompt= classification_prompt1
    elif prompt_type=="Silent-CoT":
        classification_prompt= classification_prompt3
    elif prompt_type=="Knowledge-Anchored":
        classification_prompt= classification_prompt2
...
def main():
    ...
    parser.add_argument('prompt',default='Minimalist',  help='type of prompt')
    ...
    if prompt_type='Neighbor-Guided':
        texts = prompt
    else:
    ...
    generate_sudo_labels(texts,LLM,prompt_type, label_list, reverse_label_map, batch_size, dataset_name)
